...
# Paths de datasets
data = pd.read_csv('/LabSWPP12023S2G2/TPInicial/data.csv')
data3d = pd.read_csv('/LabSWPP12023S2G2/TPInicial/data3d.csv')
data_ref = pd.read_csv('/LabSWPP12023S2G2/TPInicial/data_ref.csv')
